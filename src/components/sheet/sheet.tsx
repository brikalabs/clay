  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-(--sheet-gap) bg-background shadow-sheet transition ease-in-out [backdrop-filter:blur(var(--sheet-backdrop-blur,0px))] data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
