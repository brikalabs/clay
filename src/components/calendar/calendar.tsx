...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'corner-themed border-(length:--card-border-width) w-fit rounded-card border-border bg-card-container p-4 text-card-label shadow-card [border-style:var(--card-border-style)]',
        className
      )}
      formatters={{
