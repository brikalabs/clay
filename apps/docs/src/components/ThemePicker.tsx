  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="group inline-flex h-8 items-center gap-2 rounded-md border border-clay-hairline bg-clay-elevated pr-1.5 pl-1.5 backdrop-blur-popover transition-colors hover:border-clay-default hover:bg-clay-base"
      >
      ...
      {open && (
        <div
          role="menu"
          className="absolute top-full right-0 z-40 mt-2 w-72 overflow-hidden rounded-lg border border-clay-hairline bg-clay-elevated shadow-xl backdrop-blur-popover"
        >
