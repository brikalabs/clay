...
const MenubarMenu = withSlot(MenubarPrimitive.Menu, 'menubar-menu');
const MenubarGroup = withSlot(MenubarPrimitive.Group, 'menubar-group');
const MenubarPortal = withSlot(MenubarPrimitive.Portal, 'menubar-portal');
const MenubarSub = withSlot(MenubarPrimitive.Sub, 'menubar-sub');
const MenubarRadioGroup = withSlot(MenubarPrimitive.RadioGroup, 'menubar-radio-group');
